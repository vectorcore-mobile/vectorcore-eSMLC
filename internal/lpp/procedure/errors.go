...
var (
	...
	ErrUnrequestedOTDOA       = errors.New("lpp procedure: OTDOA capability was not requested")
	ErrUnrequestedAGNSS       = errors.New("lpp procedure: A-GNSS capability was not requested")
	ErrInvalidLocationRequest = errors.New("lpp procedure: invalid request-location payload")
	ErrInvalidLocationProvide = errors.New("lpp procedure: invalid provide-location payload")
)
